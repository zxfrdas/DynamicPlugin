...
import com.zt.plugin.brightness.R;
...
public class RoundProgressBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawCircle(centre, centre, radius - SHADOW_WIDTH_HALF, paint); //画出圆环
		...
		paint.setShadowLayer(SHADOW_WIDTH, 0, 0, roundProgressColor);
		this.setLayerType(View.LAYER_TYPE_SOFTWARE, paint);
		RectF oval = new RectF(centre - radius+SHADOW_WIDTH_HALF, centre - radius+SHADOW_WIDTH_HALF, centre
				+ radius - SHADOW_WIDTH_HALF, centre + radius - SHADOW_WIDTH_HALF);  //用于定义的圆弧的形状和大小的界限
